...
export const originSynergy: {
  ...
  Demon: [
    {
      require: 2,
      bonus:
        "デーモンの攻撃は相手の30％の確率で相手のマナを無くし、同量のTrueダメージを与える"
    },
    {
      require: 4,
      bonus:
        "デーモンの攻撃は相手の50％の確率で相手のマナを無くし、同量のTrueダメージを与える"
    },
    {
      require: 6,
      bonus:
        "デーモンの攻撃は相手の70％の確率で相手のマナを無くし、同量のTrueダメージを与える"
    }
  ],
  Dragon: [{ require: 2, bonus: "ドラゴンは魔法ダメージを受けない" }],
  Exile: [
    {
      require: 1,
      bonus:
        "近くに他のチャンピオンがいない場合、最大ヘルスの割合に応じたシールドを得る"
    }
  ],
  Glacial: [
    {
      require: 1,
      bonus: "グレイシャルの攻撃は25％の確率で2秒間のスタンを与える"
    },
    {
      require: 4,
      bonus: "グレイシャルの攻撃は35％の確率で2秒間のスタンを与える"
    },
    {
      require: 6,
      bonus: "グレイシャルの攻撃は45％の確率で2秒間のスタンを与える"
    }
  ],
  Robot: [{ require: 1, bonus: "ロボットはマナが最大の状態で戦闘開始する" }],
  Imperial: [
  ...
  Noble: [
    {
      require: 3,
      bonus: "ランダムな味方1体はARが100上昇し攻撃毎に35HPを回復する"
    },
  ...
  Wild: [
    {
      require: 3,
      bonus: "ワイルドは攻撃毎にフューリースタックを得て攻撃速度が上昇する"
    },
    {
      require: 6,
      bonus: "すべての味方は攻撃毎にフューリースタックを得て攻撃速度が上昇する"
    }
  ],
  Void: [{ require: 3, bonus: "基本攻撃が敵のARの50%を無視するようになる" }],
  Yordle: [
...
export const classSynergy: {
  ...
  Assassin: [
    {
      require: 3,
      bonus:
        "アサシンは戦闘開始時に最も遠い敵に飛びつき+150％のクリティカルダメージを与える"
    },
    {
      require: 6,
      bonus:
        "アサシンは戦闘開始時に最も遠い敵に飛びつき+350％のクリティカルダメージを与える"
    }
  ],
  Blademaster: [
    {
      require: 2,
      bonus: "ブレードマスターは攻撃毎に35％の確率で追加攻撃を行う"
    },
    {
      require: 4,
      bonus: "ブレードマスターは攻撃毎に35％の確率で2回追加攻撃を行う"
    }
  ],
  Brawler: [
  ...
  Guardian: [
    {
      require: 2,
      bonus:
        "戦闘開始時に全てのガーディアンと隣接する味方ユニットのARが30上昇する"
    }
  ],
  Gunslinger: [
    {
      require: 2,
      bonus:
        "ガンスリンガーは攻撃後にランダムな敵に対して追加攻撃を行う場合がある"
    },
    {
      require: 4,
      bonus:
        "ガンスリンガーは攻撃後に全ての射程内の敵に対して追加攻撃を行う場合がある"
    }
  ],
  Knight: [
  ...
  Sorcerer: [{ require: 3, bonus: "味方が与えるAPダメージが上昇する" }]
  /* eslint-enable prettier/prettier */
};
